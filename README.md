...
大类  |公查证书数  |云号授权费<br/>总额范围  |标准年费  |标配容量
:----:|-----------:|------------------------:|---------:|---------:
C1    |50万-100万  |3000CRC                  |300CRC    |300T
C2    |40万-50万   |1000CRC                  |200CRC    |100T
C3    |30万-40万   |300CRC                   |100CRC    |80T
C4    |10万-30万   |150CRC-160CRC            |50CRC     |60T
C5    |5万-10万    |100CRC-140CRC            |40CRC     |20T
A1    |3万-5万     |70CRC-90CRC              |30CRC     |10T
A2    |1万-3万     |46CRC-50CRC              |20CRC     |6T
A3    |5千-1万     |38CRC-42CRC              |18CRC     |2T
A4    |3千-5千     |34CRC-36CRC              |16CRC     |1T
W1    |2千-3千     |32CRC                    |15CRC     |1T
W2    |1千-2千     |31CRC                    |15CRC     |1T
W3    |<1千        |30CRC                    |15CRC     |1T

统一配置： <br/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上传文件：单个文件最大不能超过20MB <br/>

#### 小类

> 由小类确定「云号授权费的总额」及「云号授权费的风险额度」

小类   |公查证书数     |云号授权费<br/>总额  |云号授权费<br/>风险额度  |标准年费  |大类
:-----:|--------------:|--------------------:|------------------------:|---------:|-----:
C1.00  |500000-999999  |3000CRC              |300CRC                   |300CRC    |C1
C2.00  |400000-499999  |1000CRC              |100CRC                   |200CRC    |C2
C3.00  |300000-399999  |300CRC               |30CRC                    |100CRC    |C3
C4.01  |200000-299999  |160CRC               |16CRC                    |50CRC     |C4
C4.02  |100000-199999  |150CRC               |15CRC                    |50CRC     |C4
C5.01  |90000-99999    |140CRC               |14CRC                    |40CRC     |C5
C5.02  |80000-89999    |130CRC               |13CRC                    |40CRC     |C5
C5.03  |70000-79999    |120CRC               |12CRC                    |40CRC     |C5
C5.04  |60000-69999    |110CRC               |11CRC                    |40CRC     |C5
C5.05  |50000-59999    |100CRC               |10CRC                    |40CRC     |C5
A1.01  |40000-49999    |90CRC                |10CRC                    |30CRC     |A1
A1.02  |30000-39999    |70CRC                |10CRC                    |30CRC     |A1
A2.01  |20000-29999    |50CRC                |10CRC                    |20CRC     |A2
A2.02  |10000-19999    |46CRC                |10CRC                    |20CRC     |A2
A3.01  |9000-9999      |42CRC                |10CRC                    |18CRC     |A3
A3.02  |8000-8999      |41CRC                |10CRC                    |18CRC     |A3
A3.03  |7000-7999      |40CRC                |10CRC                    |18CRC     |A3
A3.04  |6000-6999      |39CRC                |10CRC                    |18CRC     |A3
A3.05  |5000-5999      |38CRC                |10CRC                    |18CRC     |A3
A4.01  |4000-4999      |36CRC                |10CRC                    |16CRC     |A4
A4.02  |3000-3999      |34CRC                |10CRC                    |16CRC     |A4
W1.00  |2000-2999      |32CRC                |10CRC                    |15CRC     |W1
W2.00  |1000-1999      |31CRC                |10CRC                    |15CRC     |W2
W3.00  |<1000          |30CRC                |10CRC                    |15CRC     |W3
...
对于小型机构，年费可能会有压力，所以小机构请谨慎购买！ <br/>
我们方向就是：适配高网速，大吞吐，渲染富信息，以求高品质，做不了低端，只能做高端，所以最低年费15CRC
...
这才是重点，我希望通过我的努力，把这个做成一代经典！

我专做、只做、特做认证机构管理系统，希望喜欢武侠文化的认证机构大佬鼎力支持！
